...
class UserController extends ApiController
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return $this->notAuthorized("You are not authorized to create this user");
    }
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return $this->notAuthorized("You are not authorized to update this user");
    }
    ...
    public function replace(ReplaceUserRequest $request, User $user)
    {
        ...
        return $this->notAuthorized("You are not authorized to replace this user");
    }
    ...
    public function destroy(User $user)
    {
        ...
        return $this->notAuthorized("You are not authorized to delete this user");
    }
}
